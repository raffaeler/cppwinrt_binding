...
// If you've installed the Windows 10 SDK Preview Build 17661, or later, 
// then you can just directly use the winrt::single_threaded_observable_vector<T> type 
// instead of the code listing below. If you're not already on that version of the SDK,
// then it will be easy to switch over from using the code listing version to the winrt
// type when you are.
//
// Raising the event:
