...
struct WINRT_EBO Binding2_base : implements<D, BindingViewModels::IBinding2, Windows::UI::Xaml::Controls::IControlOverrides, Windows::UI::Xaml::Controls::IControlOverrides6, Windows::UI::Xaml::Controls::IPageOverrides, Windows::UI::Xaml::Data::INotifyPropertyChanged, Windows::UI::Xaml::IFrameworkElementOverrides, Windows::UI::Xaml::IFrameworkElementOverrides2, Windows::UI::Xaml::IUIElementOverrides, Windows::UI::Xaml::IUIElementOverrides7, Windows::UI::Xaml::IUIElementOverrides8, composing, I...>,
...
{
    using base_type = Binding2_base;
    using class_type = BindingViewModels::Binding2;
    using implements_type = typename Binding2_base::implements_type;
    ...
    {
        return L"BindingViewModels.Binding2";
    }
    Binding2_base()
    {
...
struct WINRT_EBO Binding2T : implements<D, Windows::Foundation::IActivationFactory, I...>
{
    hstring GetRuntimeClassName() const
    {
        return L"BindingViewModels.Binding2";
...
#if defined(WINRT_FORCE_INCLUDE_BINDING2_XAML_G_H) || __has_include("Binding2.xaml.g.h")

#include "Binding2.xaml.g.h"
...
{
    template <typename D, typename... I>
    using Binding2T = Binding2_base<D, I...>;
}
